...
public class Intent implements Parcelable, Cloneable {
    ...
    /**
     * @hide Activity to challenge the user for a PIN that was configured when setting up
    ...
    /**
     * @hide Categories for activities that can participate in voice interaction.
    ...
    /**
     * @hide Used as a boolean extra field in {@link Intent#ACTION_PACKAGE_REMOVED}
    ...
    /**
     * @hide Magic extra system code can use when binding, to give a label for
    ...
    /**
     * @hide Magic extra system code can use when binding, to give a PendingIntent object
    ...
    public static boolean isAccessUriMode(int modeFlags) {
        return (modeFlags & (Intent.FLAG_GRANT_READ_URI_PERMISSION | Intent.FLAG_GRANT_WRITE_URI_PERMISSION)) != 0;
    }
    ...
    public void prepareToLeaveProcess() {
        ...
        if (mData != null && StrictMode.vmFileUriExposureEnabled()) {
            ...
            if (ACTION_VIEW.equals(mAction) || ACTION_EDIT.equals(mAction) || ACTION_ATTACH_DATA.equals(mAction)) {
