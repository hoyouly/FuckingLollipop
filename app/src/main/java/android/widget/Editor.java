...
public class Editor {
    ...
    private void destroyDisplayListsData() {
        if (mTextDisplayLists != null) {
            for (int i = 0; i < mTextDisplayLists.length; i++) {
                RenderNode displayList = mTextDisplayLists[i] != null ? mTextDisplayLists[i].displayList : null;
        ...
        if (layout instanceof DynamicLayout) {
            ...
            for (int i = 0; i < numberOfBlocks; i++) {
                ...
                if (mTextDisplayLists[blockIndex] == null) {
                    mTextDisplayLists[blockIndex] = new TextDisplayList("Text " + blockIndex);
                }
                ...
                ((HardwareCanvas) canvas).drawRenderNode(blockDisplayList, null, 0 /* no child clipping, our TextView parent enforces it */);
    ...
    private DragShadowBuilder getTextThumbnailBuilder(CharSequence text) {
        ...
        shadowView.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
    ...
    class SpanController implements SpanWatcher {
        ...
        private boolean isNonIntermediateSelectionSpan(final Spannable text, final Object span) {
            return (Selection.SELECTION_START == span || Selection.SELECTION_END == span) && (text.getSpanFlags(span) & Spanned.SPAN_INTERMEDIATE) == 0;
        }
    ...
    private class SuggestionsPopupWindow extends PinnedPopupWindow implements OnItemClickListener {
        ...
        private class SuggestionInfo {
            ...
            TextAppearanceSpan highlightSpan = new TextAppearanceSpan(mTextView.getContext(), R.style.TextAppearance_SuggestionHighlight);
        }
    ...
    private class SelectionActionModeCallback implements Callback {
        ...
        public boolean onCreateActionMode(ActionMode mode, Menu menu) {
            ...
            menu.add(0, TextView.ID_SELECT_ALL, 0, com.android.internal.R.string.selectAll).
                    setIcon(styledAttributes.getResourceId(R.styleable.SelectionModeDrawables_actionModeSelectAllDrawable, 0)).
                    setAlphabeticShortcut('a').
                    setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS | MenuItem.SHOW_AS_ACTION_WITH_TEXT);

            if (mTextView.canCut()) {
                menu.add(0, TextView.ID_CUT, 0, com.android.internal.R.string.cut).
                        setIcon(styledAttributes.getResourceId(R.styleable.SelectionModeDrawables_actionModeCutDrawable, 0)).
            ...
            if (mTextView.canCopy()) {
                menu.add(0, TextView.ID_COPY, 0, com.android.internal.R.string.copy).
                        setIcon(styledAttributes.getResourceId(R.styleable.SelectionModeDrawables_actionModeCopyDrawable, 0)).
            ...
            if (mTextView.canPaste()) {
                menu.add(0, TextView.ID_PASTE, 0, com.android.internal.R.string.paste).
                        setIcon(styledAttributes.getResourceId(R.styleable.SelectionModeDrawables_actionModePasteDrawable, 0)).
