	...
	public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
		switch (code) {
			...
			case SCHEDULE_LAUNCH_ACTIVITY_TRANSACTION: {
				...
				scheduleLaunchActivity(intent, b, ident, info, curConfig, compatInfo, referrer, voiceInteractor, procState, state, persistentState, ri, pi, notResumed, isForward, profilerInfo);
				return true;
			}
			...
			case BIND_APPLICATION_TRANSACTION: {
				...
				bindApplication(packageName, info, providers, testName, profilerInfo, testArgs, testWatcher, uiAutomationConnection, testMode, openGlTrace, restrictedBackupMode, persistent, config, compatInfo, services, coreSettings);
				return true;
			}
...
class ApplicationThreadProxy implements IApplicationThread {
	...
	public void scheduleBackgroundVisibleBehindChanged(IBinder token, boolean enabled) throws RemoteException {
		...
		mRemote.transact(BACKGROUND_VISIBLE_BEHIND_CHANGED_TRANSACTION, data, null, IBinder.FLAG_ONEWAY);
		data.recycle();
	}
