...
/*package*/ final class DexPathList {
     ...
     *                           接受之前传进来的包含 dex 的 apk/jar/dex 的路径集、
    ...
    public DexPathList(ClassLoader definingContext, String dexPath, String libraryPath, File optimizedDirectory) {
       ...
       //调用 makePathElements() 方法生成一个 Element[] dexElements 数组
    ...
    public String toString() {
        return "DexPathList[" + Arrays.toString(dexElements) + ",nativeLibraryDirectories=" + Arrays.toString(nativeLibraryDirectories) + "]";
    }
