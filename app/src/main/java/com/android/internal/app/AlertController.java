...
public class AlertController {
    ...
    public AlertController(Context context, DialogInterface di, Window window) {
        ...
        mButtonPanelSideLayout = a.getResourceId(com.android.internal.R.styleable.AlertDialog_buttonPanelSideLayout, 0);
            ...
            decor.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() {
                ...
                public WindowInsets onApplyWindowInsets(View view, WindowInsets insets) {
                    if (insets.isRound()) {
                        ...
                        int roundOffset = mContext.getResources().getDimensionPixelOffset(R.dimen.alert_dialog_round_padding);
    ...
    private void setupView() {
        ...
        if (mView != null) {//如果用户设置了内容视图，那么他将显示customPanel的custom布局里面
            customView = mView;
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController dialog) {
            ...
            if (mIsMultiChoice) {
                ...
                if (mCursor == null) {
                    adapter = (mAdapter != null) ? mAdapter : new CheckedItemAdapter(mContext, layout, R.id.text1, mItems);
                } else {
