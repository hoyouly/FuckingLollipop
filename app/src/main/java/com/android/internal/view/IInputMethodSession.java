...
public interface IInputMethodSession extends android.os.IInterface {
     ...
     */
    public static abstract class Stub extends android.os.Binder implements IInputMethodSession {
         ...
         */
        public static IInputMethodSession asInterface(android.os.IBinder obj) {
            if ((obj == null)) {
                return null;
            }
        ...
        private static class Proxy implements IInputMethodSession {
            ...
            @Override
            public void appPrivateCommand(String action, android.os.Bundle data) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
