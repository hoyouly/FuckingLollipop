...
public interface IInputContext extends android.os.IInterface {
     ...
     */
    public static abstract class Stub extends android.os.Binder implements IInputContext {
         ...
         */
        public static IInputContext asInterface(android.os.IBinder obj) {
            if ((obj == null)) {
                return null;
            }
        ...
        private static class Proxy implements IInputContext {
            ...
            @Override
            public void setComposingText(CharSequence text, int newCursorPosition) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    if ((text != null)) {
            ...
            @Override
            public void commitText(CharSequence text, int newCursorPosition) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    if ((text != null)) {
            ...
            @Override
            public void performPrivateCommand(String action, android.os.Bundle data) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
