...
public interface IInputMethod extends android.os.IInterface {
     ...
     */
    public static abstract class Stub extends android.os.Binder implements IInputMethod {
         ...
         */
        public static IInputMethod asInterface(android.os.IBinder obj) {
            if ((obj == null)) {
                return null;
            }
        ...
        public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException {
            switch (code) {
                ...
                case TRANSACTION_startInput: {
                    data.enforceInterface(DESCRIPTOR);
                    IInputContext _arg0;
                    _arg0 = IInputContext.Stub.asInterface(data.readStrongBinder());
        ...
        private static class Proxy implements IInputMethod {
            ...
            @Override
            public void startInput(IInputContext inputContext, android.view.inputmethod.EditorInfo attribute) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
            ...
            @Override
            public void restartInput(IInputContext inputContext, android.view.inputmethod.EditorInfo attribute) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    _data.writeStrongBinder((((inputContext != null)) ? (inputContext.asBinder()) : (null)));
