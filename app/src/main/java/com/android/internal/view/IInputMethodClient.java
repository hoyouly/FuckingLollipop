...
public interface IInputMethodClient extends android.os.IInterface {
     ...
     */
    public static abstract class Stub extends android.os.Binder implements IInputMethodClient {
         ...
         */
        public static IInputMethodClient asInterface(android.os.IBinder obj) {
            if ((obj == null)) {
                return null;
            }
        ...
        private static class Proxy implements IInputMethodClient {
            ...
            @Override
            public void onBindMethod(InputBindResult res) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    if ((res != null)) {
